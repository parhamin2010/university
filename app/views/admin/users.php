    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?= URL; ?>adminpanel/user"><i class="fa fa-users"></i> Users</a></li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">مدیریت اعضا</h3>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                foreach ($users as $user) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;vertical-align:middle"><img onerror="this.src='public/images/user-default-image.jpg'" width="50px"
                                                                           src="<?= $user['image']; ?>" /></td>
                                        <td style="text-align:center;vertical-align:middle"><?= $user['registery_date']; ?></td>
                                    </tr>
                                    <?php
                                    $i++;
                                }
        ...
        <div class="modal-dialog" style="width: 300px;">
            ...
            <div class="modal-content">
                <div class="modal-header" style="color: #fff;background: #2484c6;">
                    ...
                    <h4 class="modal-title">حذف سبک</h4>
                </div>
                <div class="modal-body" style="padding: 0 15px;text-align: right;text-align: right;">
                    <div id="form-regular-login" class="login-fold" style="display: inline;block">
                        <p class="email-wrap">
                            <label style="font-size: .9em;color: #777;display: inline-block;margin-top: 10px;font-weight: 700;">آیا از حذف این سبک اطمینان دارید؟</label>
                        </p>
                        <div class="row" style="margin-right: 0;margin-left: 15px;">
                            <div class="sign-up-inside-login">
                                <button id="login-submit" class="btn btn-danger">حذف</button>
                ...
                <div class="modal-footer" style="margin-top: 10px !important;font-size: .8em;background: #f8f8f8;padding: 15px;text-align: right;border-bottom: 1px solid #e5e5e5;">
                    <span>توجه کنید در صورت حذف تمامی آهنگ های مربوط به این دسته بندی نیز حذف میگردد و امکان بازیابی نیز وجود ندارد.</span>
                </div>
            </div>
        </div>
    </div>
...
<script src="public/panel/dist/js/demo.js"></script>
...
<script>
    $(document).on("click", ".btn btn-danger", function () {
        ...
        $.post(
            ...
            function (data) {
                if (data == "error") {
                    generate('success', '<div class="activity-item">' + p_id + '</div>');
                }
                else {
                    generate('success', '<div class="activity-item">' + p_id + '</div>');
                }

    ...
    e.VERSION = "1.6.2", e.DEFAULTS = {
        ...
        constructor: e, init: function () {
            ...
            var b = this, d = [], e = 0, f = function (a, b, c) {
                ...
                return '<a tabindex="0"' + ("undefined" != typeof e ? ' class="' + e + '"' : "") + ("undefined" != typeof f ? ' style="' + f + '"' : "") + ("undefined" != typeof g ? 'data-optgroup="' + g + '"' : "") + ' data-normalized-text="' + h + '">' + d + '<span class="' + b.options.iconBase + " " + b.options.tickIcon + ' icon-ok check-mark"></span></a>'
            };

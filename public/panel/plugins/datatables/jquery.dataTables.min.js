...
(function (Ea, Q, k) {
    var P = function (h) {
        ...
        function P(a) {
            ...
            !a.sEmptyTable && (c && "متاسفانه اطلاعاتی یافت نشد" === b.sEmptyTable) && E(a, a, "sZeroRecords", "sEmptyTable");
        ...
        function ob(a) {
            var b = a.oClasses, c = a.sTableId, e = a.oLanguage, d = a.oPreviousSearch, f = a.aanFeatures, g = '<input style="border-radius: 3px;margin-right: 5px" type="search" class="' + b.sFilterInput + '"/>', j = e.sSearch, j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g, b = h("<div/>", {
        ...
        m.defaults = {
            ...
            oLanguage: {
                ...
                sEmptyTable: "متاسفانه اطلاعاتی یافت نشد",
                sInfo: "نمایش _START_ تا _END_ از _TOTAL_ نتیجه",
                sInfoEmpty: "هیچ نتیجه ای یافت نشد",
                sInfoFiltered:"",// "(filtered from _MAX_ total entries)",
                sInfoPostFix: "",
                sDecimal: "",
                sThousands: ",",
                sLengthMenu: "نمایش _MENU_ نتیجه",
                sLoadingRecords: "اندکی صبر کنید...",
                sProcessing: "درحال پردازش...",
                sSearch: "جستجو:",
                sSearchPlaceholder: "",
                sUrl: "",
                sZeroRecords: "متاسفانه هیچ نتیجه ای یافت نشد"
            },
